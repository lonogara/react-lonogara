...
var Preload = function(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement('span', a$3('WRAP'), children)
  )
}
...
var Main = function(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Exhibit, null),
      detail && React.createElement(Detail, null)
    )
  )
}
...
var Burger = function() {
  return React.createElement(
    ...
    React.createElement(
      'g',
      a$8('G'),
      React.createElement('path', a$8('PATH_0')),
      React.createElement('path', a$8('PATH_1')),
      React.createElement('path', a$8('PATH_2'))
    )
  )
}
...
var Button = function(_ref) {
  ...
  return React.createElement(
    'div',
    a$9('ROOT'),
    React.createElement('span', a$9('CHILDREN_WRAP'), children),
    inform > 0 && React.createElement('div', a$9('INFORM'), inform),
    React.createElement(
      'div',
      a$9('CLICK_COVER', {
    ...
    },
    {
      ...
      value: function tree() {
        ...
        return React.createElement(
          ...
          React.createElement('nav', a('BUTTONS'), buttons, veil),
          React.createElement(
            'aside',
            a('SIDES', {
              style: {
